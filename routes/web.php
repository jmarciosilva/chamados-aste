...
Route::prefix('agent')
    ...
    ->group(function () {
        ...
        Route::post('/ticket/{ticket}/reopen', [AgentTicketController::class, 'reopen'])
            ->name('tickets.reopen');
...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::get('/', function (TicketQueueService $queueService) {
    ...
    ->name('queue');
        ...
        */
        ...
        Route::get('support-groups/{supportGroup}/agents', [SupportGroupController::class, 'agents'])->name('support-groups.agents');
        Route::post('support-groups/{supportGroup}/agents', [SupportGroupController::class, 'updateAgents'])->name('support-groups.agents.update');
