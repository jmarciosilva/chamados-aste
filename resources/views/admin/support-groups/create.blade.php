...
@section('title', 'Novo Grupo de Atendimento')
@section('subtitle', 'Cadastro de grupo de suporte')
...
@section('content')
    ...
    <div class="flex items-center gap-2 text-sm text-slate-600 mb-6">
        ...
        <span class="text-slate-900 font-medium">Novo Grupo</span>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200">
            ...
            <div class="px-8 py-6 border-b border-slate-200">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h2 class="text-xl font-semibold text-slate-900">Dados do Grupo</h2>
                        <p class="text-sm text-slate-600 mt-1">
                            Preencha as informações abaixo para cadastrar um novo grupo de atendimento
                        </p>
                    </div>
                </div>
            </div>
            ...
            {{-- FORMULÁRIO --}}
            <form action="{{ route('admin.support-groups.store') }}" method="POST">
                @csrf
                ...
                <div class="px-8 py-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="SERVICE_DESK"
                                   required>
                            <p class="text-xs text-slate-500 flex items-center gap-1">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                Código interno único (ex: SERVICE_DESK, ERP, INFRA)
                            </p>
                            @error('code')
                                <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="description"
                                  ...
                                  placeholder="Descreva as responsabilidades e atribuições deste grupo...">{{ old('description') }}</textarea>
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="users[]"
                            ...
                            @forelse($technicians as $tech)
                                <option value="{{ $tech->id }}" 
                                        ...
                                        @selected(collect(old('users', []))->contains($tech->id))>
                        ...
                        <div class="flex items-start gap-2 text-xs text-slate-500">
                            ...
                            <div>
                                <p class="font-medium text-slate-600">Como selecionar:</p>
                                <ul class="list-disc list-inside mt-1 space-y-0.5">
                                    <li><strong>Windows/Linux:</strong> Segure <kbd class="px-1.5 py-0.5 bg-slate-200 rounded text-[10px] font-mono">CTRL</kbd> e clique nos técnicos</li>
                                    <li><strong>Mac:</strong> Segure <kbd class="px-1.5 py-0.5 bg-slate-200 rounded text-[10px] font-mono">CMD</kbd> e clique nos técnicos</li>
                                </ul>
                            </div>
                        </div>
                    </div>
